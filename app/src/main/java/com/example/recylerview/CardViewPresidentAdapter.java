...
public class CardViewPresidentAdapter extends RecyclerView.Adapter<CardViewPresidentAdapter.CardViewViewHolder> {
    ...
    public CardViewPresidentAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_card_view,viewGroup,
                false);
    ...
    public void onBindViewHolder(@NonNull CardViewViewHolder cardViewViewHolder, int i) {
        ...
        cardViewViewHolder.btnFavorite.setOnClickListener(new CustomOneItemClickListener(i,
                new CustomOneItemClickListener.OnItemClickCallback() {
            @Override
        ...
        cardViewViewHolder.btnShare.setOnClickListener(new CustomOneItemClickListener(i,
                new CustomOneItemClickListener.OnItemClickCallback() {
                    @Override
                    public void onItemClicked(View view, int position) {
